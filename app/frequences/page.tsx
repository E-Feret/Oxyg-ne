...
const FREQUENCIES = [
    { city: "Melun", freq: "88.4" },
    { city: "Fontainebleau", freq: "89.3" },
    { city: "Meaux", freq: "95.8" },
    { city: "Provins", freq: "99.6" },
    { city: "Coulommiers", freq: "106.4" },
    { city: "Montereau", freq: "106.6" },
    { city: "Nemours", freq: "107.3" },
    { city: "La Ferté-sous-Jouarre", freq: "106.5" },
];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16 space-y-4">
                    <h1 className={`${anton.className} text-5xl md:text-7xl text-white uppercase tracking-tight drop-shadow-lg`}>
                        NOS <span className="text-oxy-orange">FRÉQUENCES</span>
                    </h1>
                    <p className="text-xl text-white/80 font-medium max-w-2xl mx-auto">
                        Partout avec vous en Seine-et-Marne
                    </p>
                </div>
